...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Цель проекта – онлайн-продажи и формирование узнаваемости бренда. Основной акцент сделан на визуальной подаче коллекций, удобном каталоге и быстром оформлении заказа.',
    results: [
  ...
  },
  {
    ...
    industry: 'Лендинг | Одностраничный сайт',
    description:
    ...
    functionalityTitle: 'Функциональность лендинга',
  },
];
