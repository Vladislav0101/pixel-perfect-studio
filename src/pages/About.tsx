      ...
      <section className="pt-28 md:pt-32 pb-10 md:pb-16 md:pt-40 md:pb-24">
        <div className="container-custom">
          ...
          >
            ...
            Мы – команда экспертов в области веб-разработки, создающая цифровые решения, которые напрямую поддерживают бизнес-цели клиентов. <br />
            Работаем структурировано, без избыточной бюрократии и лишних процессов: фокус исключительно на качестве, эффективности и измеримом результате.
            </p>
          </motion.div>
        </div>
      </section>
