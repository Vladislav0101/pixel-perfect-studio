...
const steps = [
  {
    ...
    title: 'Знакомство',
    description:
      'Мы изучаем ваш бизнес, цели и видение. Без шаблонов — всё начинается с понимания ваших уникальных потребностей.',
  },
  {
    icon: Pencil,
    title: 'Дизайн и стратегия',
    description:
      'Мы создаём макеты и дизайны, адаптированные под ваш бренд. Вы просматриваете и даёте обратную связь, пока вы не увидите то, что хотели.',
  },
  {
    icon: Code2,
    title: 'Разработка',
    description:
      'Мы разрабатываем ваш сайт на базе современных технологий, которые обеспечивают быструю загрузку, адптив под мобильные устройства и полную SEO-оптимизацию.',
  },
  {
    icon: Rocket,
    title: 'Запуск и поддержка',
    description: 'Мы разворачиваем ваш сайт и проводим обучение.',
  },
];
